...
MODEL_PATH='./CausalMAE_master/output/pretrain_causalMae/phase2/checkpoint-49.pth'
# path to tensorboard
...
CUDA_VISIBLE_DEVICES=0,1  python -m torch.distributed.launch --nproc_per_node=2 --master_port=8675 --use_env run_causalMae_evaluation.py \
